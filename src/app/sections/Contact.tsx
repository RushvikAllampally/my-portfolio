...
const Contact: React.FC = () => {
  ...
  return (
    <motion.div
      ref={ref}
      className="container m-auto flex flex-col xl:flex-row justify-center xl:justify-between gap-12 my-8"
      variants={variants}
      initial="initial"
      whileInView="animate"
    >
      <motion.div className="flex-1 flex flex-col gap-10" variants={variants}>
        <motion.div variants={variants}>
          <motion.h1 className="h1" variants={variants}>
            Let's <span className="text-accent">work together</span>
          </motion.h1>
        </motion.div>

        <motion.div variants={variants}>
          <h2 className="h3">Mail</h2>
          <h3 className="">rushvik249@gmail.com</h3>
        </motion.div>
        <motion.div variants={variants}>
          <h2>Address</h2>
      ...
      <div className="flex-1">
        <motion.div
          ...
          className="absolute m-auto stroke-white -z-50"
        >
